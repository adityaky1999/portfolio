...
const GithubIcon = ({ size = 17 }: { size?: number }) => (
  <svg aria-hidden="true" width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 .7a12 12 0 0 0-3.79 23.4c.6.11.82-.26.82-.58v-2.03c-3.34.73-4.04-1.61-4.04-1.61-.55-1.4-1.34-1.77-1.34-1.77-1.09-.75.08-.74.08-.74 1.2.08 1.84 1.23 1.84 1.23 1.07 1.83 2.8 1.3 3.48.99.11-.77.42-1.3.76-1.6-2.67-.3-5.47-1.34-5.47-5.93 0-1.31.47-2.38 1.23-3.22-.12-.3-.53-1.52.12-3.17 0 0 1.01-.32 3.3 1.23a11.46 11.46 0 0 1 6-.81 11.5 11.5 0 0 1 6 .81c2.29-1.55 3.3-1.23 3.3-1.23.65 1.65.24 2.87.12 3.17.76.84 1.23 1.91 1.23 3.22 0 4.6-2.8 5.63-5.48 5.92.43.37.81 1.1.81 2.22v3.29c0 .32.22.69.83.57A12 12 0 0 0 12 .7Z" />
  </svg>
);

const LinkedInIcon = ({ size = 17 }: { size?: number }) => (
  <svg aria-hidden="true" width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M4.98 3.5a2.5 2.5 0 1 1 0 5.001 2.5 2.5 0 0 1 0-5.001ZM2.75 9.25h4.46V21.5H2.75V9.25Zm7.25 0h4.28v1.68h.06c.6-1.14 2.06-2.34 4.24-2.34 4.53 0 5.37 2.98 5.37 6.86v6.05h-4.46v-5.36c0-1.28-.02-2.93-1.79-2.93-1.79 0-2.07 1.4-2.07 2.84v5.45H10V9.25Z" />
  </svg>
);
...
const projects = [
  { index: "01", title: "Outlet-SKU Universe & Clustering", description: "Defined and scoped the Outlet-SKU universe for POG and non-POG retailers, using dimensionality reduction and clustering to focus analysis on high-impact segments.", tags: ["PCA", "Clustering", "Retail Analytics"] },
  { index: "02", title: "Predictive Sales Modelling", description: "Built predictive sales models to estimate baseline volume across outlets and SKUs using POS sales and historical trends, then connected outputs to downstream planning.", tags: ["Forecasting", "Machine Learning", "POS Data"] },
  { index: "03", title: "Display Optimization Framework", description: "Built an end-to-end display planning pipeline to identify high-potential outlets and forecast uplift, with architecture for distribution sell-in recommendations.", tags: ["Optimization", "Pipeline", "Recommendations"] },
];

const experience = [
  { period: "AUG 2024 — PRESENT", role: "Senior Data Scientist", company: "Sigmoid Analytics", details: ["Outlet-SKU universe definition and high-impact segmentation for POG and non-POG retailers.", "PCA across 30+ features, capturing 80%+ of data variance for efficient clustering.", "Predictive sales modelling and integration into display planning, compliance tracking and sell-in simulations.", "Display planning and pre-display forecast architecture for field broker recommendations."] },
  { period: "OCT 2020 — AUG 2024", role: "Data Science Consultant", company: "", details: ["Worked with clients to understand data science requirements and build tailored solutions.", "Built predictive models to automate demand forecasting processes.", "Improved existing model accuracy by 15%–20% through feature engineering and selection.", "Owned projects end-to-end across acquisition, cleaning, modelling, deployment and reporting.", "Created Power BI views of machine-learning model performance metrics."] },
];
...
export default function Portfolio() {
  return (
    <main id="top" className="grain min-h-screen bg-[#070707] text-[#f5f5f2]">
      <nav className="fixed left-0 right-0 top-0 z-50 border-b border-white/10 bg-black/45 px-5 backdrop-blur-xl md:px-10">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between">
          <a href="#top" className="font-display text-sm font-semibold uppercase tracking-[0.2em]" aria-label="Back to top">AY<span className="text-[#d6ff00]">.</span></a>
      ...
      <section className="grid-bg relative flex min-h-screen items-end overflow-hidden px-5 pb-20 pt-32 md:px-10 md:pb-24">
      ...
      <section id="contact" className="px-5 py-28 md:px-10 md:py-44">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-14 flex flex-wrap gap-3">
            ...
            <a href="https://www.linkedin.com/in/aditya-yadav-b18451166" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 rounded-full border border-white/15 px-6 py-4 text-sm font-semibold transition hover:-translate-y-1 hover:border-white/30"><LinkedInIcon /> LinkedIn <ArrowUpRight size={15} /></a>
            <a href="https://github.com/adityaky1999" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 rounded-full border border-white/15 px-6 py-4 text-sm font-semibold transition hover:-translate-y-1 hover:border-white/30"><GithubIcon /> GitHub <ArrowUpRight size={15} /></a>
          </div>
